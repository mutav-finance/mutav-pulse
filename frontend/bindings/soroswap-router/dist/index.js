...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAQAAAAAAAAAAAAAAEEluaXRpYWxpemVkRXZlbnQAAAABAAAAAAAAAAdmYWN0b3J5AAAAABM=",
    ...
    fromJSON = {
        ...
        swap_exact_tokens_for_tokens: (this.txFromJSON),
        swap_tokens_for_exact_tokens: (this.txFromJSON),
        get_factory: (this.txFromJSON),
        router_pair_for: (this.txFromJSON),
        router_quote: (this.txFromJSON),
        router_get_amount_out: (this.txFromJSON),
        router_get_amount_in: (this.txFromJSON),
        router_get_amounts_out: (this.txFromJSON),
        router_get_amounts_in: (this.txFromJSON),
        sort_tokens: (this.txFromJSON),
        pair_for: (this.txFromJSON),
        get_reserves: (this.txFromJSON),
        quote: (this.txFromJSON),
        get_amount_out: (this.txFromJSON),
        get_amount_in: (this.txFromJSON),
        get_amounts_out: (this.txFromJSON),
        get_amounts_in: (this.txFromJSON)
    };
}
