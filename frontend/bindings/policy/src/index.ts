...
export interface Client {
   ...
   */
  sign_guarantee: ({landlord, monthly_amount, months_covered, fee_bps, period_secs}: {landlord: string, monthly_amount: i128, months_covered: u32, fee_bps: u32, period_secs: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u32>>>
